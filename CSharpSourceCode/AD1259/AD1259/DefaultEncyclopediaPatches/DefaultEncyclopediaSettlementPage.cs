...
{
	[HarmonyPatch(typeof(DefaultEncyclopediaSettlementPage), "InitializeFilterItems")]
	public class DefaultEncyclopediaSettlementPage_InitializeFilterItems_Patch
	{
