...
{
	[HarmonyPatch(typeof(CharacterCreationCampaignBehavior), "YouthGuardGarrisonRegisterOptionOnCondition")]
	public class YouthGuardGarrisonRegisterOptionOnConditionPatch
	{
